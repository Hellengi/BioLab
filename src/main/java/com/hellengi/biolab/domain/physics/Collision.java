...
public class Collision {
    ...
    public void keepInside(Cell cell, double radius) {
        keepInside(cell, radius, true);
    }

    public void keepInside(Cell cell, double radius, boolean reflect) {
    ...
    private void resolveWallCollision(
        ...
        cell.recordCollisionImpulse(Math.abs(impulse), -nx, -ny);
    }
